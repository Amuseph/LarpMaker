  ...
  def get_description(character)
    ...
    when 'Channel Divinity'
      case character.deity.name
        ...
        when 'Enoon'
          return '“Long Rest - Deep Woods Only - You may expend this skill to gain, “Recoil, Snare” against melee weapon strikes for the next 5 minutes'
        when 'Ixbus'
          return 'You may submit to the Craft Bin with the required materials and Labor any recipe, as if you have the required Profession.'
        when 'Naenya'
    ...
    when 'Divine Inspiration'
      case character.deity.name
        ...
        when 'Ixbus'
          return 'You may expend 2 Labor to receive a random component. You can do this as many times as you have labor.'
        when 'Naenya'
